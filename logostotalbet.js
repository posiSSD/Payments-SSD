...
// Función que se ejecuta cuando se detecta un cambio en el DOM
function onMutations(mutationsList, observer) {
    mutationsList.forEach(function(mutation) {
        ...
        // Verificar si se modificaron los atributos de algún nodo en el DOM
        else if (mutation.type === 'attributes') {
            var targetNode = mutation.target;
            // Verificar si el nodo modificado es el div deseado
            if (targetNode.classList && 
                targetNode.classList.contains('style__Container-sc-g7ftgu-1') && 
